    ...
    <table border="1" align="center">
        ...
        <tr>
            ...
            <td height="500px" width="700px" align="center">
                <form action="../php/cPassCheck.php" method="POST">
                    <fieldset>
                        <legend><b>Change Password</b></legend>
                        Old password:<input type="password" name="oldpass"> <br><hr>
                        New password:<input type="password" name="newpass"><br><hr>
                        Confirm password:<input type="password" name="cnewpass"><br><hr>
                        Do you sure want to change password?
