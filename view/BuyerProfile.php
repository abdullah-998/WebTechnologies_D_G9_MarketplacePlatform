        ...
        <tr>
            ...
            <td height="550px" width="700px">
               <fieldset>
                   ...
                   <a href="sReview.php"><input type="button" name="review" value="see reviews"></a>
                   <?php
                        if(!$_SESSION['type']!==1)
                        {
                            echo '<a href="message.php"><input type="button" name="review" value="send message"></a> ';
                            echo '<a href="gReview.php"><input type="button" name="report" value="give review"></a> ';
                            echo '<a href="report.php"><input type="button" name="report" value="give report"></a> ';
                            echo '<a href="sendProject.php"><input type="button" name="project" value="send project"></a>';
                        }
                    ?>
               </fieldset>
               <fieldset>
                   ...
                   About Me: I am a rich man living in Dubai<br><hr>
