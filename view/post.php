            ...
            <td height="600px" width="700px">
                <?php
                    if(!$_SESSION['type']==1)
                    {
                        ...
                        echo '<form action="postCheck.php" method="POST">
                            <fieldset>
                ...
                <form action="postCheck2.php" method="POST">
                    <fieldset>
                        ...
                        <a href="BuyerProfile.php"><img src="../asset/user.png" height="30px" width="30px">User 2</a> posted 2 days ago<br><br>
                        ...
                        <hr>
                        <a href="apply.php"><input type="button" name="btnapply" value="apply"></a>
                        <a href="message.php"><input type="button" name="btnmsg" value="send message"><br></a>
                        <hr><hr>
                        <a href="BuyerProfile.php"><img src="../asset/user.png" height="30px" width="30px">User 3</a> posted 2 hours ago<br><br>
                        I need a high skilled web devoloper<br>
                        Type: Web Dev<br>
                        Tags: html,php<br>
                        Price: $500<br>
